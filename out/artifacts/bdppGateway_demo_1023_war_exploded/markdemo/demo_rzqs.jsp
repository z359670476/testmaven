  ...
  <div class="layui-form-item" ><!-- style="display: none;" -->
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" name="makeId"  autocomplete="off" class="layui-input" value="<%=MarkEnum.MARKCODE.getValue()%>">
      </div>
    </div>
  </div>
...
<!--   </div> -->
  ...
  <div class="layui-form-item">
    <div class="layui-input-block">
      <button class="layui-btn" lay-submit="" lay-filter="demo1"><i class="layui-icon">&#xe681;</i>上传清算文件</button>
      <button class="layui-btn" lay-submit="" lay-filter="create"><i class="layui-icon">&#xe601;</i>查看清算文件</button>
    </div>
  </div>
</form>
...
data.field.save=true; */
  ...
  form.on('submit(create)', function(data){
	  data.field.action="createFile";
	  var $eleForm = $("<form method='get' action='../demo/demo_buss_servlet.jsp'>"+
