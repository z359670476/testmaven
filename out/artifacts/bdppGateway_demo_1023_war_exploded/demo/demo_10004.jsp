...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend>企业投资人换卡</legend>
</fieldset>
 
<form class="layui-form" action="http://101.231.114.246:8080/interface/market/comExchangeCard.do" target= "_blank" method="post">
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" name="busiCode"  autocomplete="off" class="layui-input" value="10004">
      </div>
    </div>
  </div>
  <div class="layui-form-item">
...
layui.use(['form'], function(){
  ...
  $("input[name='seatNo']").val("001");
  $("input[name='subAcctNo']").val("1000652018031410414511000201");
