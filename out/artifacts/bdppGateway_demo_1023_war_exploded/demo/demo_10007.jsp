...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend>企业B2B结果查询</legend>
</fieldset>
 
<form class="layui-form" action="http://101.231.114.246:8080/interface/market/comB2BQuery.do" target= "_blank" method="post">
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" name="busiCode"  autocomplete="off" class="layui-input" value="10007">
      </div>
    </div>
  </div>
  <div class="layui-form-item">
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      <label class="layui-form-label" style="width: 180px;">交易日期(transDate)</label>
      <div class="layui-input-inline">
        <input type="text" name="transDate"  autocomplete="off" class="layui-input clear">
      </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      <label class="layui-form-label" style="width: 180px;">原市场流水号(serialNo)</label>
      <div class="layui-input-inline">
        <input type="text" name="serialNo"  autocomplete="off" class="layui-input clear">
      </div>
    </div>
  </div>
  <div class="layui-form-item">
...
layui.use(['form'], function(){
  ...
  $("input[name='serialNo']").val("201710241049081018400");
  $("input[name='transDate']").val("20171024");
