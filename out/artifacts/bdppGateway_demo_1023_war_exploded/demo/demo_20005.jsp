...
<form class="layui-form"  method="post">
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" name="FtSeq"  autocomplete="off" class="layui-input clear" style="width: 300px;">
      </div>
    </div>
  </div>
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" name="SrcDate"  autocomplete="off" class="layui-input clear" style="width: 300px;">
      </div>
    </div>
  </div>
...
layui.use(['form'], function(){
  ...
  $("input[name='FtSeq']").val("20171026141556479618");
  $("input[name='SrcDate']").val("20171026");
