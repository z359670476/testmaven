...
<form class="layui-form"  method="post">
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" name="BusCd"  autocomplete="off" class="layui-input" value="20010">
      </div>
    </div>
  </div>
  <div class="layui-form-item">
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" name="AccType"  autocomplete="off" class="layui-input clear"  >
      </div>
      <div class="layui-form-mid layui-word-aux">0:市场，1：个人</div>
    </div>
  </div>
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" name="AcctNo"  autocomplete="off" class="layui-input clear"  >
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item" style="text-align:center;">
    <div class="layui-input-block">
      ...
      <button class="layui-btn" lay-submit="" lay-filter="demo2">提交保存</button>
      <button class="layui-btn" lay-submit="" lay-filter="demo3">一键查询</button>
    </div>
  </div>
</form>
...
layui.use(['form'], function(){
  ...
  $("input[name='AccType']").val("0");//0-市场 1-投资人
  $("input[name='AcctNo']").val("1000650000001");
...
//     })
  ...
  form.on('submit(demo3)', function(data){
    ...
    $.ajax({
		...
		dataType : "text",
		success : function(res) {
			layer.msg("数据库变化："+res.split("|***|")[0].trim()+"条;共计消耗"+res.split("|***|")[1].trim()+"秒");
		},
		error : function(XMLHttpRequest, textStatus, errorThrown) {
			alert("signature fail: " + XMLHttpRequest.status + " , "
					+ XMLHttpRequest.readyState + " , " + textStatus);
