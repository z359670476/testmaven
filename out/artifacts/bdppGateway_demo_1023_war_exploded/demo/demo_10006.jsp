...
<form class="layui-form" action="http://101.231.114.246:8080/interface/market/comB2B.do" target= "_blank" method="post">
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" name="busiCode"  autocomplete="off" class="layui-input" value="10006">
      </div>
    </div>
  </div>
  <div class="layui-form-item">
...
layui.use(['form'], function(){
  ...
  $("input[name='transAmt']").val("10000000");
  $("input[name='acctNo']").val("1000652018041609313611000201");
