...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend>查询投资人开户及银行卡绑定状态</legend>
</fieldset>
 
<form class="layui-form" action="http://101.231.114.246:8080/interface/market/backQuery.do" target= "_blank" method="post">
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" name="busiCode"  autocomplete="off" class="layui-input" value="10005">
      </div>
    </div>
  </div>
  <div class="layui-form-item">
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      <label class="layui-form-label" style="width: 180px;">查询时间(transTime)</label>
      <div class="layui-input-inline">
