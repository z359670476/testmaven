...
<body>  
 ...
 <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend>投资人买管理</legend>
</fieldset>
<div style="margin-left: 20px;width: 95%;">
	
	<table class="layui-table" lay-data="{ even:true,page:true ,url:'demo_buss_tzrbuy.jsp',limit:'5',where: {method: 'queryBuyList'},method: 'post',initSort:{field:'CREATE_TIME', type:'desc'}}" lay-filter="demo">
	  <thead>
	    <tr>
...
//       layer.alert('编辑行：<br>'+ JSON.stringify(data))
      ...
      layer.open({
      	  ...
      	  content: 'demo_tzrbuy_add.jsp?v=edit',
      	  area: ['836px', '417px'],
      	  moveOut :true,
      	  end: function(){
      		  	if(editData.ret){
  ...
  $("#add").click(function(){
	  layer.open({
      	  ...
      	  //area: ['500px', '300px'],
      	  skin: 'layui-layer-lan',
      	  title: ['新增投资人买交易信息', 'font-size:18px;'],
      	  content: 'demo_tzrbuy_add.jsp',
      	  area: ['836px', '417px'],
      	  moveOut :true,
      	  end: function(){
    		    if(addRet){
					parent.$("#iframe").attr("src","jys/demo_tzrbuy.jsp");
    		    }
    	  }
  	});
