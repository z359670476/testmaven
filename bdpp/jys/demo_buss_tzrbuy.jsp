...
// 		System.out.println( fy.getNextPageJson());
		...
		String addSql="insert into TBL_BDPP_DEAL_BUY(ID,MARKET_CD,SEAT_NO，INVESTOR_ID,SYS_ACCT_NO,SUBJECT_NAME,TRANS_AT,SERVICE_FEE,STATUS,REMARK,IS_DEL,CREATE_TIME) values(SEQ_BDPP_DEAL_BUY.Nextval,?,?,?,?,?,?,?,?,?,0,sysdate )";
