...
<form class="layui-form"  method="post">
    ...
    <div class="layui-form-item isHide">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="hidden" name="BusCd"  autocomplete="off" class="layui-input" value="20003">
                <div class="layui-form-mid layui-word-aux">20003</div>
            </div>
        </div>
    </div>
    <div class="layui-form-item isHide">
    ...
    <div class="layui-form-item isHide" style="text-align:center;">
        <div class="layui-input-block">
            <button class="layui-btn" lay-submit="" lay-filter="save">发送个人投资人入金指令</button>
        </div>
    </div>
