  ...
  form.on('submit(demo1)', function(data){
    ...
    $.ajax({
		...
		success : function(res) {
			if(res.code==0){
				var $eleForm = $("<form method='get' action='../demo/demo_ftp_servlet.jsp'>"+
						"<input type='hidden' name='action' value='isexis'>"+
	...
	function down(mname){
		 $.ajax({
				url : "../demo/demo_ftp_servlet.jsp?action=isexis&name="+mname,
				type : "get",
				dataType : "text",
				success : function(res) {
					if(res.trim()=="文件不存在"){
